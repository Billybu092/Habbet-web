...
if "youtube.com" in url or "youtu.be" in url:
    ...
    with col_win:
        st.markdown('<a href="https://github.com/Billybu092/Habbet-web/releases/download/v1.1.0/Habbet_Eli_t7ebb_Setup_v1.1.exe" class="win-download">📥 WINDOWS APP (FREE)</a>', unsafe_allow_html=True)
    with col_and:
...
# --- FOOTER ---
st.divider()
st.markdown('<div style="text-align: center;"><a href="https://buymeacoffee.com/bileljelassi" target="_blank"><img src="https://cdn.buymeacoffee.com/buttons/v2/default-yellow.png" style="height: 45px !important;" ></a></div>', unsafe_allow_html=True)
